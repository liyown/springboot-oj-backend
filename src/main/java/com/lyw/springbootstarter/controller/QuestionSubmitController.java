...
import com.lyw.springbootstarter.judge.judgeservice.DefaultJudgeService;
...
public class QuestionSubmitController {
    ...
    @Resource
    private DefaultJudgeService defaultJudgeService;
    ...
    public BaseResponse<Long> add(@RequestBody QuestionSubmitAddRequest request) {
